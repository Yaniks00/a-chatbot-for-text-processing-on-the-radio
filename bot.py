...
Твои тексты должны соответствовать следующим параметрам (получены на основе анализа 412 новостей):

1. Структура новости:
   - Вступление: примерно 13% текста (в среднем 21.5 слов), содержит основную суть события.
   - Основная часть: 79% текста (в среднем 135.0 слов), раскрывает детали, факты, цитаты.
   - Заключение: 9% текста (в среднем 14.7 слов), подводит итог или упоминает последствия.

2. Длина и сложность предложений:
   - Средняя длина предложения: 16.5 слов (от 0 до 107 слов).
   - Среднее количество предложений в новости: 10.6.
   - Среднее количество слов в новости: 171.2.
   - Предложения должны быть преимущественно простыми или сложносочинёнными, избегай излишней вложенности.

3. Удобочитаемость (индекс Флеша для русского языка):
   - Среднее значение: 41.1 (диапазон 0–100, чем выше – тем легче). Это соответствует стилю информационных новостей.

4. Порядок слов: не анализировался (установите spaCy для более точных рекомендаций).

5. Лексика и стиль:
   - Используй активные глаголы, избегай пассивных конструкций.
   - Употребляй конкретные числительные, названия организаций и географические названия.
   - Избегай канцеляризмов и длинных цепочек родительных падежей.
   - Придерживайся нейтрального, информационного тона.

---
Напиши новость на заданную тему, строго соблюдая все перечисленные параметры. Текст должен быть связным, логичным и соответствовать стилю новостного эфира.
"""
